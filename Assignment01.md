...
|9. Help users recognize, diagnose, and recover from errors: Error messages/problems should be expressed and suggest a solution to solve them |                 | Improvement: Include tutorials of how to play the game especially for first time players. Having a question bot would make it helpful to anser any questions.                |
